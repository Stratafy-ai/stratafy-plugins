...
Call `get_expert_strategies` with the CMO expert ID to get all strategies this expert owns.

If that fails, fall back to `list_strategies` and filter for marketing/brand/category/SEO strategies.
